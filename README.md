...
Modified code is inspired of the work of Jeff Grunewald - https://github.com/jeffgrunewald/techradar

### Setting up your data
Unlike the original BYOR from Thoughtworks this modified version don't use Google spreadsheet og csv as datasource.
The data source is a versioned json-file in the `data` folder.
